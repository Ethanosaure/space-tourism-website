  ...
  return (
    <div className="flex h-[100%] w-[100%] justify-between md:absolute md:h-[10%] xl:mt-[2%] ">
      <div className="absolute pl-[2.5%] pt-[20px]">
        <img
          src="../space-tourism-website/public/assets/shared/logo.svg"
          alt="logo"
        />
      </div>
      ...
      >
        <div
          className={`m-[40px] h-[21px] w-[24px] ${isOpen ? " self-end bg-[url('../space-tourism-website/public/assets/shared/icon-close.svg')] bg-contain bg-no-repeat" : "bg-[url('../space-tourism-website/public/assets/shared/icon-hamburger.svg')]"}  md:hidden`}
          onClick={handleClick}
        ></div>

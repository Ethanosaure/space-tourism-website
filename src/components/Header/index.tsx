...
const Component = () => {
  ...
  return (
    <div className="flex h-[100%] w-[100%] justify-between md:absolute md:h-[10%] xl:mt-[2%] ">
      ...
      <div
        className={`fixed right-0 top-0 z-10 m-0 flex h-[100%] flex-col md:h-[100%] md:max-h-[80px] md:min-h-[70px] md:w-[65%] md:flex-row md:bg-white md:bg-opacity-5 md:backdrop-blur-xl xl:max-h-[100px] ${isOpen ? " h-[100%] w-[70%] bg-white bg-opacity-5 backdrop-blur-xl" : ""}`}
      >
        <div

...
const Component = () => {
  ...
  return (
    <div className="flex h-screen min-h-[840px] w-screen flex-col bg-[url('/space-tourism-website/assets/crew/background-crew-mobile.jpg')] bg-cover bg-center bg-no-repeat md:min-h-[1120px] md:bg-[url('/space-tourism-website/assets/crew/background-crew-tablet.jpg')]    xl:min-h-[915px] xl:bg-[url('/space-tourism-website/assets/crew/background-crew-desktop.jpg')]">

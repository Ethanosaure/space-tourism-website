...
const Component = () => {
  ...
  return (
    <div className="flex h-screen min-h-[880px] w-screen flex-col bg-[url('../space-tourism-website/public/assets/technology/background-technology-mobile.jpg')] bg-cover  bg-center bg-no-repeat md:min-h-[1035px] md:bg-[url('../space-tourism-website/public/assets/technology/background-technology-tablet.jpg')] xl:min-h-[880px] xl:min-w-[1150px] xl:bg-[url('../space-tourism-website/public/assets/technology/background-technology-desktop.jpg')] ">

...
const Component = () => {
  ...
  return (
    <div className="flex h-screen min-h-[930px] w-screen flex-col items-center justify-start bg-[url('/space-tourism-website/assets/home/background-home-mobile.jpg')] bg-cover bg-center bg-no-repeat pt-[25%] md:bg-[url('/space-tourism-website/assets/home/background-home-tablet.jpg')]  xl:min-h-[830px] xl:flex-row  xl:justify-around xl:bg-[url('/space-tourism-website/assets/home/background-home-desktop.jpg')] xl:pt-[10%]">

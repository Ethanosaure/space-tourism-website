...
const Component = () => {
  ...
  return (
    <div
      id="error-page"
      className="flex h-screen min-h-[500px] w-screen flex-col items-center justify-center bg-[url('/assets/destination/background-destination-mobile.jpg')] bg-cover bg-center bg-no-repeat  md:min-h-[550px] md:bg-[url('/assets/destination/background-destination-tablet.jpg')] xl:min-h-[630px] xl:bg-[url('/assets/destination/background-destination-desktop.jpg')] "
    >
      <Heading
        kind="h1"
